...
int main() {
    ...
    psm::TickResult empty{5, std::nullopt, psm::DiverterPosition::Straight, psm::Mode::Idle,
                           psm::BeltMotorState::Stopped, emptySensors, std::nullopt};
    ...
    psmCheck(!empty.event.has_value(), "TickResult can represent a tick with no system event");
    ...
    psm::TickResult withItem{6, psm::Item{1, psm::Zone::Diverting, 750}, psm::DiverterPosition::Moving,
                              ...
                              psm::SystemEventKind::DiverterNotReady};
    ...
    psmCheck(withItem.event == psm::SystemEventKind::DiverterNotReady, "TickResult carries a system event");
