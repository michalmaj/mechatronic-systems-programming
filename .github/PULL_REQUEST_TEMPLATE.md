## Summary — Zakres zmiany

<!-- What does this PR change, and why? / Co zmienia ten PR i dlaczego? -->

## Tests — Testy

- [ ] `ctest --preset test` passes locally / przechodzi lokalnie
- [ ] No existing test was changed just to make it pass — behavior changes are explained below /
...
- [ ] No accidental changes to `module-*` tags or Course Core checkpoints / Brak przypadkowych zmian
      tagów `module-*` ani checkpointów Course Core

## Behavior change — Zmiana zachowania

<!--
If this PR changes observable behavior, name the exact contract that changed and why.
Jeśli ten PR zmienia obserwowalne zachowanie, nazwij dokładny kontrakt, który się zmienił, i dlaczego.
-->
